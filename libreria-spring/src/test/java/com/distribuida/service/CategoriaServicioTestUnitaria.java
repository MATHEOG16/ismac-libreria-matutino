...
public class CategoriaServicioTestUnitaria {
    ...
    public void setUp(){
        ...
        categoria.setDescripcion("El amor esta en el universo");
    }
    ...
    public void testSave(){
        ...
        assertEquals("Romance", categoria1.getCategoria());
    }
    ...
    public void testUpdateExistente(){
        ...
        categoriaActualizado.setCategoria("Terror");
        categoriaActualizado.setDescripcion("No hagas ruido");
        ...
        assertEquals("Terror", categoriaResultado.getCategoria());
