...
public class FacturaControllerTestIntegracion {
    ...
    public void testFindAll() throws Exception {
        Factura factura = new Factura(1,"FAC-0001",new Date(),100.00,15.00,115.00,new Cliente());
    ...
    public void testSave() throws Exception {
        Factura factura = new Factura(1,"FAC-0002",new Date(),12.90,12.20,25.10,new Cliente());
