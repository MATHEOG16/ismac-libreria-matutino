...
public class CategoriaControllerTestIntegracion {
    ...
    public void testFindAll() throws Exception {
        Categoria categoria = new Categoria(1, "Romance", "El amor esta en el universo");

        Mockito.when(categoriaService.findAll()).thenReturn(List.of(categoria));

        mockMvc.perform(get("/categorias"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[0].categoria").value("Romance")
        );
    }

    @Test
    public void testSave() throws Exception {
        Categoria categoria = new Categoria(0, "Romance", "El amor esta en el universo");
        ...
        mockMvc.perform(post("/categorias")
                        ...
                        .andExpect(jsonPath("$.categoria").value("Romance")
        );
    }
