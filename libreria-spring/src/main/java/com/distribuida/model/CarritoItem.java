...
@Entity
@Table(name = "carrito_item", uniqueConstraints = @UniqueConstraint(columnNames = {"id_carrito", "id_libro"}))
public class CarritoItem {
    ...
    public void calcTotal(){
        ...
        total = precioUnitario.multiply(BigDecimal.valueOf(cantidad)).setScale(2, RoundingMode.HALF_UP);
    }
    // getters and setters
